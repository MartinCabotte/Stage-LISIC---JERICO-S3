...
<figcaption css="text-align: center;">Bananas dataset</figcaption>
</figure>
...
```
cd existing_repo
git remote add origin https://gitlab.com/epoisson/clusteringevidentiel.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/epoisson/clusteringevidentiel/-/settings/integrations)
